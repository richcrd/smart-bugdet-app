...
import { colors, COLORS_PALETTE } from "../../constants/colors";
import { ICON_CATALOG, getIconByKey } from "../../constants/iconCatalog";
import type { CategoryResponse, SubcategoryResponse } from "../../data/catalog";
import {
  useCreateCategory,
...
export function CategorySheetContent({ onSnapChange }: Props) {
